...
let bg_img_preinstall = {
    ...
    "4": "https://t.alcy.cc/pc", // 随机动漫
    "5": "https://t.alcy.cc/ysz", // 随机动漫
	...
	"10": "https://t.alcy.cc/moe", // 随机动漫
	"11": "https://t.alcy.cc/moez", // 随机动漫
...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        case "1":
            $('#bg').attr('src', `./img/background${1 + ~~(Math.random() * 5)}.webp`) //随机默认壁纸
            break;
        case "2":
